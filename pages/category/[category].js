...
export default function Home() {
    ...
    return (
        <>
            <Meta title={'All ' + category?.charAt(0).toUpperCase() + category?.slice(1)} />
            <h1 className="text-center font-bold text-4xl my-4">{category?.charAt(0).toUpperCase() + category?.slice(1)}`s Collection</h1>
